...
//	public static String filePath = "D:\\upload\\orc2\\";
//
...
//			File dir = new File(filePath+"train3");
...
//		}
//		ImageIO.write(img, "JPG", new File(filePath+"result3\\" + result + ".jpg"));
//		return result;
//	}
//
...
//	                }  
//	                // 读取内容  
//	                String picName = filePath+"img3\\" + i + ".jpg";  
...
//		File dir = new File(filePath+"\\temp3");
//		File[] files = dir.listFiles();
//		for (File file : files) {
//			BufferedImage img = removeBackgroud(filePath+"temp3\\" + file.getName());
//			List<BufferedImage> listImg = splitImage(img);
//			if (listImg.size() > 0) {
//				for (int j = 0; j < listImg.size(); ++j) {
//					ImageIO.write(listImg.get(j), "JPG",
//							new File(filePath+"train3\\" + file.getName().charAt(j) + "-" + (index++) + ".jpg"));
//				}
//			}
//		}
//	}
	...
	public static void main(String[] args) throws Exception {
		/*for (int i = 0; i < 30; ++i) {
			BufferedImage img = removeBackgroud(filePath+"img3\\" + i + ".jpg");
			ImageIO.write(img, "JPG", new File(filePath+"result3\\" + i + ".jpg"));
		}*/
		//trainData();
		//downloadImage();
		/*for (int i = 0; i < 30; ++i) {
			String text = getAllOcr(filePath+"img3\\" + i + ".jpg");
